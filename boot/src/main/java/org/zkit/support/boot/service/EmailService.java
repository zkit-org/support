...
import org.zkit.support.boot.configuration.AliDMConfiguration;
...
public class EmailService {
    ...
    public boolean singleSendMail(EmailData data){
        ...
        IClientProfile profile = DefaultProfile.getProfile(configuration.getEndpoint(), configuration.getAccessKeyId(), configuration.getAccessKeySecret());
